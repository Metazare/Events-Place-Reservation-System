...
export const register: RequestHandler = async (
    ...
    const checkDuplicateEmail = await UserModel.exists({
...
export const registerHostDirect: RequestHandler = async (
    req: BodyRequest<RegisterHostDirect>,
    res
) => {
    const {
        email,
...
export const registerHost: RequestHandler = async (
    req: BodyRequest<RegisterHost>,
    res
) => {
    const { user } = req;
...
export const login: RequestHandler = async (
    req: BodyRequest<User["credentials"]>,
    res
) => {
...
export const checkEmail: RequestHandler = async (
    req: BodyRequest<Pick<User["credentials"], "email">>,
    res
) => {
    const emailExisting = await UserModel.exists({
