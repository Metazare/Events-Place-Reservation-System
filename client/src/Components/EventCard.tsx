...
export default function EventCard({data,type}: PropsType) {
  ...
  return (
    <div className='event-card cursor-pointer box-content relative CardHover' onClick={()=>{
      if(type==="view")navigate('/view')
    }}>
      <div className='relative w-[full] aspect-card bg-[gray]/10 rounded-md' style={{background:"url(https://www.usatoday.com/gcdn/-mm-/05b227ad5b8ad4e9dcb53af4f31d7fbdb7fa901b/c=0-64-2119-1259/local/-/media/USATODAY/USATODAY/2014/08/13/1407953244000-177513283.jpg)",backgroundSize:"cover"}}>
