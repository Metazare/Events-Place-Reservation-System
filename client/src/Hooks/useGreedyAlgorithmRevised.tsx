const useGreedyAlgorithm = () => {
    ...
    function sortData<T extends Item>(data: T[], key: keyof T, order: SortOrder = 'asc'): T[] {
...
//     { rates: 4.5, reviews: 100, location: 'New York' },
//     { rates: 4.7, reviews: 150, location: 'Los Angeles' },
//     { rates: 4.2, reviews: 90, location: 'Chicago' },
// ]);

// Use the custom hook to get the sorted items
// Sorting by the 'rates' property
// const {sortData} = useGreedyAlgorithm();
// const sortedItems = sortData(items, 'rates', 'asc');