    ...
    return (
        <Container maxWidth="lg" className="grow py-7 ">
            <div className="flex flex-col gap-4 h-[100%]  bg-[]">
                ...
                <div
                    className="flex flex-col gap-20 md:grid h-full grow  min-h-[75vh] md:items-center"
                    style={{ gridTemplateColumns: ".6fr 1fr" }}
                >
                    <div className="flex flex-col gap-6 ">
                        <h6 className="text-[38px] leading-[50px] font-bold">
                            Your Go-To{" "}
                            <span className="text-[#0071BC]">Help Desk</span>{" "}
                            <br /> for{" "}
                        ...
                        <TextField
                            ...
                            error={
                                HelpDeskFormik.touched.subject &&
                                HelpDeskFormik.errors.subject !== undefined
                            }
                        ...
                        <TextArea
                            ...
                            error={
                                HelpDeskFormik.touched.message &&
                                HelpDeskFormik.errors.message !== undefined
                            }
