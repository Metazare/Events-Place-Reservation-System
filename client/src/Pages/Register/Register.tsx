                    ...
                    <div className="flex flex-col gap-2">
                        ...
                        >
                            <TextField
                                ...
                                error={
                                    ...
                                    RegisterForm.errors.firstName !== undefined
                                }
                            ...
                            <TextField
                                ...
                                handleChange={RegisterForm.handleChange}
                                error={
                                    RegisterForm.touched.middleName &&
                                    RegisterForm.errors.middleName !== undefined
                                }
                        ...
                        >
                            <TextField
                                ...
                                error={
                                    ...
                                    RegisterForm.errors.lastName !== undefined
                                }
                            ...
                            <TextField
                                ...
                                handleChange={RegisterForm.handleChange}
                                error={
                                    RegisterForm.touched.suffixName &&
                                    RegisterForm.errors.suffixName !== undefined
                                }
                        ...
                        >
                            ...
                            <TextField
                                ...
                                handleChange={RegisterForm.handleChange}
                                error={
                                    RegisterForm.touched.contact &&
                                    RegisterForm.errors.contact !== undefined
                                }
                        ...
                        <p className="text-[13px] mt-[10px]">
                            ...
                            <span
                                className="opacity-100 cursor-pointer text-primary font-[500]"
                                onClick={() => {
                                    navigate("/login");
                                }}
                            >
