        ...
        return (
            <>
                ...
                {selectedDate === "Multiple Days" ? (
                    <>
                        <div>
                            <p className={`mb-2  font-[500]  text-[#646464]`}>
                                Date Range
                            </p>
                            <DateRange
                                dateValue={dateRange}
                ...
                <TextField
                    ...
                    error={
                        ...
                        ReservationFormik.errors.guestCount !== undefined
                    }
                ...
                <TextField
                    ...
                    error={
                        ...
                        ReservationFormik.errors.specialRequest !== undefined
                    }
                    errorMessages={ReservationFormik.errors.specialRequest}
                />
                    ...
                    {EventsPlaceData?.amenities?.map((data: any, index) => {
                        let isSelected =
                            ReservationFormik.values.amenities.find(
                                (amenity: any) =>
                                    amenity.amenityId === data.amenityId
                            ) !== undefined;
                        return (
                            <AmenitiesCard
                                data={data}
