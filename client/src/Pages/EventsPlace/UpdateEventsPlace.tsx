...
function UpdateEventsPlace() {
    ...
    const { id } = useParams();
    const { data, loading, error, getEventsPlace, updateEventsPlace } =
        useEventsPlace();
                    ...
                    {activeStep === steps.length ? (
                        ...
                        <div>
                            {activeStep === 0 && (
                                <div className="flex flex-col gap-4">
                                    <TextField
                                        ...
                                        errorMessages={
                                            typeof UpdateFormik.errors.name
                                        }
                                    />
                                    <TextArea
                                    ...
                                    <div className="md:flex gap-5">
                                        ...
                                        <TextField
                                            ...
                                            error={
                                                UpdateFormik.touched.rate &&
                                                UpdateFormik.errors.rate !==
                                                    undefined
                                            }
                                            errorMessages={
                                                typeof UpdateFormik.errors.rate
                                            }
                                        />
                                    </div>
                                    <ButtonNavigate
                            ...
                            {activeStep === 1 && (
                                <div className="flex flex-col gap-4">
                                    <AddAmenities
                                        value={UpdateFormik.values.amenities}
                                        setAmenities={UpdateFormik}
                                    />
                                    <div
                                    ...
                                    >
                                        {UpdateFormik.values.amenities.map(
                                                ...
                                                <div
                                                    ...
                                                    onClick={() => {
                                                        ...
                                                        UpdateFormik.setFieldValue(
                                                            "amenities",
                                                            UpdateFormik.values.amenities.filter(
                                                                (item, i) =>
                                                                    i !== index
                                                            )
                                                        );
                            ...
                            {activeStep === 2 && (
                                <div className="flex flex-col gap-4">
                                    ...
                                    >
                                        {UpdateFormik.values.images.map(
                                            (image: any, index: number) => (
                                                <div
                                                    ...
                                                    onClick={() => {
                                                        UpdateFormik.setFieldValue(
                                                            "images",
                                                            UpdateFormik.values.images.filter(
                                                                (item, i) =>
                                                                    i !== index
                                                            )
                                                        );
