    ...
    return (
        <Routes>
            <Route element={<Base />}>
                ...
                <Route
                    path="/eventsplace/view/:id"
                    element={<ViewEventsPlace />}
                />
                ...
                <Route element={<ProtectedRoute allowedRoles={["Host"]} />}>
                    <Route
                        path="/eventsplace/create"
                        element={<CreateEventsPlace />}
                    />
                    <Route
                        path="/eventsplace/update/:id"
                ...
                <Route
                    element={
                        <ProtectedRoute allowedRoles={["Renter", "Host"]} />
                    }
                >
            ...
            <Route element={<ProtectedRoute allowedRoles={["Admin"]} />}>
                <Route element={<AdminBase />}>
                    ...
                    <Route
                        path="/admin/eventsplace"
                        element={<EventsPlace />}
                    />
                    <Route
                        path="/admin/reservationlogs"
