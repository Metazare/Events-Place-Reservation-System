        ...
        >
            <div className="bg-[white] shadow-md hidden md:flex flex-col ">
                ...
                <div className="grow  py-4">
                    ...
                    <MenuItem
                        ...
                        title={"Events Place"}
                        active={
                            window.location.pathname === "/admin/eventsplace"
                        }
                        clickHandle={() => {
                            navigate("/admin/eventsplace");
                        }}
                    />
                    ...
                    <MenuItem
                        ...
                        title={"Help Desk"}
                        active={window.location.pathname === "/admin/helpdesk"}
                        clickHandle={() => {
            ...
            <div className="grow">
                <div className="bg-[#EFEFEF] px-4 h-[100px] flex justify-between items-center">
                    <div>
                        <h5 className="text-[20px] font-bold text-[#2D74B4]">
                            Dashboard
                        </h5>
...
function MenuItem({ icon, title, clickHandle, active }) {
    return (
        <div
            className={`flex gap-2 items-center border-r-4 cursor-pointer p-4 ${
                !active &&
                "hover:bg-[black]/5 border-[transparent] text-[black]/60 "
            } ${
                active &&
                "bg-[#DDDDDD] text-[#0071BC] font-semibold border-[#0071BC]"
            }`}
